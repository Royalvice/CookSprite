...
onMounted(async () => {
  ...
  else if (store.currentProject) await router.replace(`/studio/${store.currentProject.id}`);
...
function toggleImageControl(id: string) { imageValues.value[id] = imageValues.value[id] !== true; }
